...
public class Level2Script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameManager.Instance.inLevel2 = true;
    ...
    private void OnTriggerEnter(Collider other) //When player collides with the level trigger box...
    {
        ...
        {  
                ...
                if (GameManager.Instance.currentScore > GameManager.Instance.level2Score)
                {
                    GameManager.Instance.level2Score = GameManager.Instance.currentScore; // Store score for level and keep highest score

                    if (GameManager.Instance.level2Completed == false)
                    {
    ...
    public void calculatePerformance()
    {
        ...
        {
            star1.enabled = true;
            if (GameManager.Instance.lvl2Stars < 1)
            {
                GameManager.Instance.lvl2Stars = 1;
            }
        }
        // If player rating >= 75
        // display 2 yellow
        ...
        {
            star2.enabled = true;
            if (GameManager.Instance.lvl2Stars < 2)
            {

                GameManager.Instance.lvl2Stars = 2;
            }
        }
        ...
        {
            star3.enabled = true;
            if (GameManager.Instance.lvl2Stars < 3)
            {
                GameManager.Instance.lvl2Stars = 3;
            }
        }
    }
