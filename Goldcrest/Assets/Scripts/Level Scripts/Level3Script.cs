...
public class Level3Script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameManager.Instance.inLevel3 = true;
    ...
    private void OnTriggerEnter(Collider other) //When player collides with the level trigger box...
    {
        if (other.tag == "Player")
        {
            ...
            if (GameManager.Instance.currentScore > GameManager.Instance.level3Score)
            {
                GameManager.Instance.level3Score = GameManager.Instance.currentScore; // Store score for level and keep highest score
            ...
            awardCard();
            GameManager.Instance.lvl4Unlocked = true;
    ...
    public void calculatePerformance()
    {
        ...
        {
            star1.enabled = true;
            if (GameManager.Instance.lvl3Stars < 1)
            {
                GameManager.Instance.lvl3Stars = 1;
            }
        }
        // If player rating >= 75
        // display 2 yellow
        ...
        {
            star2.enabled = true;
            if (GameManager.Instance.lvl3Stars < 2)
            {

                GameManager.Instance.lvl3Stars = 2;
            }
        }
        ...
        {
            star3.enabled = true;
            if (GameManager.Instance.lvl3Stars < 3)
            {
                GameManager.Instance.lvl3Stars = 3;
            }
        }
    }
