...
public class Level4Script : MonoBehaviour
{
    ...
    public void calculatePerformance()
    {
        ...
        {
            star1.enabled = true;
            if (GameManager.Instance.lvl4Stars < 1)
            {
                GameManager.Instance.lvl4Stars = 1;
            }
        }
        // If player rating >= 75
        // display 2 yellow
        ...
        {
            star2.enabled = true;
            if (GameManager.Instance.lvl4Stars < 2)
            {

                GameManager.Instance.lvl4Stars = 2;
            }
        }
        ...
        {
            star3.enabled = true;
            if (GameManager.Instance.lvl4Stars < 3)
            {
                GameManager.Instance.lvl4Stars = 3;
            }
        }
    }
